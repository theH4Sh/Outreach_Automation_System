const DeleteUserModal = ({ isOpen, user, loading, onClose, onConfirm }) => {
    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-5">
          <div>
            <h3 className="text-xl font-bold text-slate-900">Delete user permanently?</h3>
            <p className="mt-2 text-sm text-slate-500 leading-relaxed">
              <span className="font-semibold text-slate-800">{user.username}</span> and all their uploaded leads will be removed. This cannot be undone.
            </p>
          </div>
